...
namespace CentroServicios
{
    public class CentroServicios_NEG
    {
        ...
        /// <summary>
        /// Valor fijo de base con el cual debe iniciar la caja de una agencia o punto cada vez que se haga una apertura.
        /// </summary>
        ...
        /// <summary>
        /// Identificador del clasificador del canal de ventas, este es como se clasifica un centro de servicos en la aplicación de la ERP.
        /// </summary>
